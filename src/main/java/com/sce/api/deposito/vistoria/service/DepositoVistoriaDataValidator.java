...
public class DepositoVistoriaDataValidator {
    ...
    public void validateVistoria(long vistoriaId) throws DepositoVistoriaApiException {
    ...
    public void validateDeposito(long depositoId) throws DepositoVistoriaApiException {
