...
public class AnaliseEspecieDataValidator {
    ...
    public void validateAnalise(long analiseId) throws AnaliseEspecieApiException {
    ...
    public void validateEspecie(long especieId) throws AnaliseEspecieApiException {
