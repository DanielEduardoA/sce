...
public class ExemplarAnaliseDataValidator {
    ...
    public void validateExemplar(long exemplarId) throws ExemplarAnaliseApiException {
    ...
    public void validateEspecie(long especieId) throws ExemplarAnaliseApiException {
    ...
    public void validateAnalise(long analiseId) throws ExemplarAnaliseApiException {
