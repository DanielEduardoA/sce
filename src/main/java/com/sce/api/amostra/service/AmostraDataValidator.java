...
public class AmostraDataValidator {
    ...
    public void validateAnalise(long analiseId) throws AmostraApiException {
    ...
    public void validateVistoria(long vistoriaId) throws AmostraApiException {
    ...
    public void validateDeposito(long depositoId) throws AmostraApiException {
